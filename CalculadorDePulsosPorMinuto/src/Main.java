...
public class Main {
	...
	private static final int DURACION_AUDIO_SEGUNDOS = 14;
	...
	public static void main(String[] args) {
		...
		try {
			...
			double[] audio = convertidorAudioAArray.convertir();

			guadarEnArchivos(audio);
			
			/* Calcular las ppm en base al array obtenido */
			
			contador = new ContadorDePulsosMedianteCorrelacion(audio, DURACION_AUDIO_SEGUNDOS);
	...
	public static void guadarEnArchivos(double[] audio) throws IOException { 
